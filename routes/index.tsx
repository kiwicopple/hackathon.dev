    ...
    <div class={tw`mx-auto max-w-screen-md p-4`}>
      <section class={tw`my-12`}>
        ...
        <p class={tw`my-6 text-lg`}>
          The world's best developer tools, running the <strong>world's largest hackathon</strong>.
        </p>
        <p>
      ...
      <section class={tw`my-12`}>
        ...
        <div class={tw`my-4`}>
          ...
          <p>
            You cannot. You can only be invited to sponsor this event by offering a great Developer
            Tool, which developers can leverage during the hackathon.
          </p>
        </div>
        <div class={tw`my-4`}>
          <h3 class={tw`font-medium`}>What are the prizes?</h3>
          <p>
            Each sponsor will offer prizes which you can use to build your hackathon project into a
            scalable business.
          </p>
        </div>
        <div class={tw`my-4`}>
          <h3 class={tw`font-medium`}>Which companies are sponsoring the hackathon?</h3>
          <p>Coming soon.</p>
        </div>
        <div class={tw`my-4`}>
